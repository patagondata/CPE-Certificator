...
const rows = [
    createData('Factory Reset', "Pendiente de ejecución/validación manual", "warning", "Por favor ejecute la prueba y actualice el estado."),
];

export default function ExecutionsResultFactoryReset() {
    return (
