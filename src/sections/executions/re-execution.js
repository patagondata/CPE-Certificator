...
import { Autocomplete, SvgIcon, Table, TableBody, TableRow, TableCell, Switch, ButtonBase, Tooltip, IconButton } from '@mui/material';
...
export default function ReExecution() {
  ...
  return (
    <React.Fragment>
      ...
      <ButtonBase onClick={handleClickOpen} variant="contained" >
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Re-Ejecución de Set de Pruebas</DialogTitle>
        <DialogContent>
          <DialogContentText>
          ...
          <DialogContentText>
            Desea ejecutar solo pruebas fallidas?
            <Switch
              checked={checked}
